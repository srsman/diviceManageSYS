<html>
  ...
  <body>
  	<link href="css/indexIos.css" rel="stylesheet" type="text/css"/>
	    ...
	    <div id="show_devices">
		  ...
		  <div>
			<table id="head_info" border="1">
			  <tr>
				<th>id</th><th>设备名</th><th>型号</th><th>分辨率</th><th>内存</th><th>屏幕尺寸</th><th>SIM卡</th><th>申请设备</th><th>申请人</th><th>借出时间</th>
			  </tr>
			</table>
			  <?php 
